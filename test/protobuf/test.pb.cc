...
class GetFriendListsResposeDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<GetFriendListsRespose> _instance;
} _GetFriendListsRespose_default_instance_;
}  // namespace fixbug
...
static void InitDefaultsscc_info_GetFriendListsRespose_test_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::fixbug::_GetFriendListsRespose_default_instance_;
    new (ptr) ::fixbug::GetFriendListsRespose();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::fixbug::GetFriendListsRespose::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2> scc_info_GetFriendListsRespose_test_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 2, 0, InitDefaultsscc_info_GetFriendListsRespose_test_2eproto}, {
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_test_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendListsRespose, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendListsRespose, result_),
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendListsRespose, friendlist_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 36, -1, sizeof(::fixbug::GetFriendListsRespose)},
};
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::fixbug::_GetFriendListsRespose_default_instance_),
};
...
const char descriptor_table_protodef_test_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "serid\030\001 \001(\r\"]\n\025GetFriendListsRespose\022\"\n\006"
  "result\030\001 \001(\0132\022.fixbug.ResultCode\022 \n\nfrie"
  "ndlist\030\002 \003(\0132\014.fixbug.user2\226\001\n\016UserServi"
  "ceRpc\0224\n\005Login\022\024.fixbug.LoginRequest\032\025.f"
  "ixbug.LoginResponse\022N\n\016GetFriendLists\022\035."
  "fixbug.GetFriendListsRequest\032\035.fixbug.Ge"
  "tFriendListsResposeB\003\200\001\001b\006proto3"
  ;
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_test_2eproto_sccs[6] = {
  ...
  &scc_info_GetFriendListsRespose_test_2eproto.base,
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_test_2eproto = {
  false, false, descriptor_table_protodef_test_2eproto, "test.proto", 592,
...
void GetFriendListsRespose::InitAsDefaultInstance() {
  ::fixbug::_GetFriendListsRespose_default_instance_._instance.get_mutable()->result_ = const_cast< ::fixbug::ResultCode*>(
      ::fixbug::ResultCode::internal_default_instance());
}
class GetFriendListsRespose::_Internal {
 public:
  static const ::fixbug::ResultCode& result(const GetFriendListsRespose* msg);
};

const ::fixbug::ResultCode&
GetFriendListsRespose::_Internal::result(const GetFriendListsRespose* msg) {
  return *msg->result_;
}
GetFriendListsRespose::GetFriendListsRespose(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena),
  friendlist_(arena) {
  SharedCtor();
  RegisterArenaDtor(arena);
  // @@protoc_insertion_point(arena_constructor:fixbug.GetFriendListsRespose)
}
GetFriendListsRespose::GetFriendListsRespose(const GetFriendListsRespose& from)
  : ::PROTOBUF_NAMESPACE_ID::Message(),
  ...
  // @@protoc_insertion_point(copy_constructor:fixbug.GetFriendListsRespose)
}

void GetFriendListsRespose::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_GetFriendListsRespose_test_2eproto.base);
  result_ = nullptr;
}

GetFriendListsRespose::~GetFriendListsRespose() {
  // @@protoc_insertion_point(destructor:fixbug.GetFriendListsRespose)
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}

void GetFriendListsRespose::SharedDtor() {
  GOOGLE_DCHECK(GetArena() == nullptr);
  if (this != internal_default_instance()) delete result_;
}

void GetFriendListsRespose::ArenaDtor(void* object) {
  GetFriendListsRespose* _this = reinterpret_cast< GetFriendListsRespose* >(object);
  (void)_this;
}
void GetFriendListsRespose::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
void GetFriendListsRespose::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const GetFriendListsRespose& GetFriendListsRespose::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_GetFriendListsRespose_test_2eproto.base);
  return *internal_default_instance();
}


void GetFriendListsRespose::Clear() {
// @@protoc_insertion_point(message_clear_start:fixbug.GetFriendListsRespose)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* GetFriendListsRespose::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ::PROTOBUF_NAMESPACE_ID::Arena* arena = GetArena(); (void)arena;
  while (!ctx->Done(&ptr)) {
    ::PROTOBUF_NAMESPACE_ID::uint32 tag;
...
::PROTOBUF_NAMESPACE_ID::uint8* GetFriendListsRespose::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:fixbug.GetFriendListsRespose)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:fixbug.GetFriendListsRespose)
  return target;
}

size_t GetFriendListsRespose::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:fixbug.GetFriendListsRespose)
  size_t total_size = 0;
...
void GetFriendListsRespose::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:fixbug.GetFriendListsRespose)
  GOOGLE_DCHECK_NE(&from, this);
  const GetFriendListsRespose* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<GetFriendListsRespose>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:fixbug.GetFriendListsRespose)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:fixbug.GetFriendListsRespose)
    MergeFrom(*source);
  }
}

void GetFriendListsRespose::MergeFrom(const GetFriendListsRespose& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:fixbug.GetFriendListsRespose)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
void GetFriendListsRespose::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:fixbug.GetFriendListsRespose)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void GetFriendListsRespose::CopyFrom(const GetFriendListsRespose& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:fixbug.GetFriendListsRespose)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool GetFriendListsRespose::IsInitialized() const {
  return true;
}

void GetFriendListsRespose::InternalSwap(GetFriendListsRespose* other) {
  using std::swap;
  _internal_metadata_.Swap<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(&other->_internal_metadata_);
...
::PROTOBUF_NAMESPACE_ID::Metadata GetFriendListsRespose::GetMetadata() const {
  return GetMetadataStatic();
}
    ...
    case 1:
      GetFriendLists(controller,
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<const ::fixbug::GetFriendListsRequest*>(
                 request),
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<::fixbug::GetFriendListsRespose*>(
                 response),
             done);
      break;
    default:
...
const ::PROTOBUF_NAMESPACE_ID::Message& UserServiceRpc::GetResponsePrototype(
  ...
  switch(method->index()) {
    ...
    case 1:
      return ::fixbug::GetFriendListsRespose::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
      return *::PROTOBUF_NAMESPACE_ID::MessageFactory::generated_factory()
...
void UserServiceRpc_Stub::GetFriendLists(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
                              ...
                              ::fixbug::GetFriendListsRespose* response,
                              ::google::protobuf::Closure* done) {
...
template<> PROTOBUF_NOINLINE ::fixbug::GetFriendListsRespose* Arena::CreateMaybeMessage< ::fixbug::GetFriendListsRespose >(Arena* arena) {
  return Arena::CreateMessageInternal< ::fixbug::GetFriendListsRespose >(arena);
}
