...
class GetFriendListsRespose;
class GetFriendListsResposeDefaultTypeInternal;
extern GetFriendListsResposeDefaultTypeInternal _GetFriendListsRespose_default_instance_;
class LoginRequest;
...
template<> ::fixbug::GetFriendListsRespose* Arena::CreateMaybeMessage<::fixbug::GetFriendListsRespose>(Arena*);
...
class GetFriendListsRespose PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:fixbug.GetFriendListsRespose) */ {
 public:
  inline GetFriendListsRespose() : GetFriendListsRespose(nullptr) {}
  virtual ~GetFriendListsRespose();

  GetFriendListsRespose(const GetFriendListsRespose& from);
  GetFriendListsRespose(GetFriendListsRespose&& from) noexcept
    : GetFriendListsRespose() {
    *this = ::std::move(from);
  }

  inline GetFriendListsRespose& operator=(const GetFriendListsRespose& from) {
    CopyFrom(from);
    return *this;
  }
  inline GetFriendListsRespose& operator=(GetFriendListsRespose&& from) noexcept {
    if (GetArena() == from.GetArena()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const GetFriendListsRespose& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const GetFriendListsRespose* internal_default_instance() {
    return reinterpret_cast<const GetFriendListsRespose*>(
               &_GetFriendListsRespose_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    5;

  friend void swap(GetFriendListsRespose& a, GetFriendListsRespose& b) {
    a.Swap(&b);
  }
  inline void Swap(GetFriendListsRespose* other) {
    if (other == this) return;
    if (GetArena() == other->GetArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(GetFriendListsRespose* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  inline GetFriendListsRespose* New() const final {
    return CreateMaybeMessage<GetFriendListsRespose>(nullptr);
  }

  GetFriendListsRespose* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<GetFriendListsRespose>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const GetFriendListsRespose& from);
  void MergeFrom(const GetFriendListsRespose& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(GetFriendListsRespose* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "fixbug.GetFriendListsRespose";
  }
  protected:
  explicit GetFriendListsRespose(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  // @@protoc_insertion_point(class_scope:fixbug.GetFriendListsRespose)
 private:
  class _Internal;
...
// .fixbug.ResultCode result = 1;
inline bool GetFriendListsRespose::_internal_has_result() const {
  return this != internal_default_instance() && result_ != nullptr;
}
inline bool GetFriendListsRespose::has_result() const {
  return _internal_has_result();
}
inline void GetFriendListsRespose::clear_result() {
  if (GetArena() == nullptr && result_ != nullptr) {
    delete result_;
  }
  result_ = nullptr;
}
inline const ::fixbug::ResultCode& GetFriendListsRespose::_internal_result() const {
  const ::fixbug::ResultCode* p = result_;
  return p != nullptr ? *p : *reinterpret_cast<const ::fixbug::ResultCode*>(
      &::fixbug::_ResultCode_default_instance_);
}
inline const ::fixbug::ResultCode& GetFriendListsRespose::result() const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListsRespose.result)
  return _internal_result();
}
inline void GetFriendListsRespose::unsafe_arena_set_allocated_result(
    ::fixbug::ResultCode* result) {
  if (GetArena() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(result_);
  }
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:fixbug.GetFriendListsRespose.result)
}
inline ::fixbug::ResultCode* GetFriendListsRespose::release_result() {
...
inline ::fixbug::ResultCode* GetFriendListsRespose::unsafe_arena_release_result() {
  // @@protoc_insertion_point(field_release:fixbug.GetFriendListsRespose.result)
  
  ::fixbug::ResultCode* temp = result_;
  result_ = nullptr;
  return temp;
}
inline ::fixbug::ResultCode* GetFriendListsRespose::_internal_mutable_result() {
...
inline ::fixbug::ResultCode* GetFriendListsRespose::mutable_result() {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendListsRespose.result)
  return _internal_mutable_result();
}
inline void GetFriendListsRespose::set_allocated_result(::fixbug::ResultCode* result) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArena();
  if (message_arena == nullptr) {
    delete result_;
  }
  ...
  result_ = result;
  // @@protoc_insertion_point(field_set_allocated:fixbug.GetFriendListsRespose.result)
}

// repeated .fixbug.user friendlist = 2;
inline int GetFriendListsRespose::_internal_friendlist_size() const {
  return friendlist_.size();
}
inline int GetFriendListsRespose::friendlist_size() const {
  return _internal_friendlist_size();
}
inline void GetFriendListsRespose::clear_friendlist() {
  friendlist_.Clear();
}
inline ::fixbug::user* GetFriendListsRespose::mutable_friendlist(int index) {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendListsRespose.friendlist)
  return friendlist_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::user >*
GetFriendListsRespose::mutable_friendlist() {
  // @@protoc_insertion_point(field_mutable_list:fixbug.GetFriendListsRespose.friendlist)
  return &friendlist_;
}
inline const ::fixbug::user& GetFriendListsRespose::_internal_friendlist(int index) const {
  return friendlist_.Get(index);
}
inline const ::fixbug::user& GetFriendListsRespose::friendlist(int index) const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListsRespose.friendlist)
  return _internal_friendlist(index);
}
inline ::fixbug::user* GetFriendListsRespose::_internal_add_friendlist() {
  return friendlist_.Add();
}
inline ::fixbug::user* GetFriendListsRespose::add_friendlist() {
  // @@protoc_insertion_point(field_add:fixbug.GetFriendListsRespose.friendlist)
  return _internal_add_friendlist();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::user >&
GetFriendListsRespose::friendlist() const {
  // @@protoc_insertion_point(field_list:fixbug.GetFriendListsRespose.friendlist)
  return friendlist_;
}
